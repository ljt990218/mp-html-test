...
const block0 = {};
const node = () => Promise.resolve().then(() => L1VzZXJzL2FwcGxlL0Rlc2t0b3AvbXAtaHRtbC10ZXN0L3VuaV9tb2R1bGVzL21wLWh0bWwvY29tcG9uZW50cy9tcC1odG1sL25vZGUvbm9kZS52dWU);
const _sfc_main = {
  name: "node",
  options: {},
  data() {
  ...
  return {
    a: common_vendor.f($props.childs, (n, i, i0) => {
      return common_vendor.e({
        ...
        E: n.attrs.id,
        F: common_vendor.n((n.attrs.href ? "_a " : "") + n.attrs.class),
        G: common_vendor.s("display:inline;" + n.attrs.style),
        H: i,
        I: common_vendor.o((...args) => $options.linkTap && $options.linkTap(...args))
      } : n.name === "video" ? {
        K: n.attrs.id,
        L: common_vendor.n(n.attrs.class),
        M: common_vendor.s(n.attrs.style),
        N: n.attrs.autoplay,
        O: n.attrs.controls,
        P: n.attrs.loop,
        Q: n.attrs.muted,
        R: n.attrs["object-fit"],
        S: n.attrs.poster,
        T: n.src[$data.ctrl[i] || 0],
        U: i,
        V: common_vendor.o((...args) => $options.play && $options.play(...args)),
        W: common_vendor.o((...args) => $options.mediaError && $options.mediaError(...args))
      } : n.name === "audio" ? {
        Y: n.attrs.id,
        Z: common_vendor.n(n.attrs.class),
        ...
        ae: n.attrs.name,
        af: n.attrs.poster,
        ag: n.src[$data.ctrl[i] || 0],
        ah: i,
        ai: common_vendor.o((...args) => $options.play && $options.play(...args)),
        aj: common_vendor.o((...args) => $options.mediaError && $options.mediaError(...args))
        ...
        ao: common_vendor.f(n.children, (tbody, x, i1) => {
          return common_vendor.e({
        ...
        ap: n.attrs.id,
        aq: common_vendor.n("_" + n.name + " " + n.attrs.class),
        ar: common_vendor.s(n.attrs.style)
      }) : !n.c ? {
        at: n.attrs.id,
        av: common_vendor.s("display:inline;" + n.f),
        aw: $props.opts[4],
        ax: $props.opts[4],
        ay: [n]
      } : n.c === 2 ? {
        ...
        aB: n.attrs.id,
        aC: common_vendor.n("_block _" + n.name + " " + n.attrs.class),
...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/apple/Desktop/mp-html-test/uni_modules/mp-html/components/mp-html/node/node.vue"]]);
ks.createComponent(Component);
const L1VzZXJzL2FwcGxlL0Rlc2t0b3AvbXAtaHRtbC10ZXN0L3VuaV9tb2R1bGVzL21wLWh0bWwvY29tcG9uZW50cy9tcC1odG1sL25vZGUvbm9kZS52dWU = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null
