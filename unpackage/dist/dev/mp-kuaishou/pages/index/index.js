...
const _sfc_main = {
  data() {
    return {
      ...
      html: '<p><img style="height:100%" src="https://th.bing.com/th?id=OIP.YmBnwfkMgzoyYCS7THLfYwHaNK&w=187&h=333&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2" /></p>'
    };
  },
  onLoad() {
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.j({
      "ready": common_vendor.o($options.imgLoad)
    }),
    b: common_vendor.p({
      content: $data.html
    })
